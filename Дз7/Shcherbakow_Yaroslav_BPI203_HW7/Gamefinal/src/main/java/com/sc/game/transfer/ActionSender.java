...
public class ActionSender {
    ...
    public static void sendTopResults(ObjectOutputStream objectOutputStream, Vector<TopResultsModel> model) throws IOException {
        var transferObject = new TransferObject(ActionType.PUSH_TOP_RESULTS, model);
        send(objectOutputStream, transferObject);
    }
}
